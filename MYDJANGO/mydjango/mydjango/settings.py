...
SECRET_KEY = 'django-insecure-h45-u6hu4i*0$+387%gf701wmuda=lt325231++$vebhx15s0u'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'stu',  # 连接的数据库
        'HOST': '202.120.84.196', # mysql的ip地址
        'PORT': 3306,  # mysql的端口
        'USER': 'stu', # mysql的用户名
        'PASSWORD': '123456'  # mysql的密码
    }
}
#https://blog.csdn.net/weixin_44634704/article/details/118198037
# DATABASES = {
#     'default': {
